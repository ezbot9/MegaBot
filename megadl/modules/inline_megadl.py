...
async def inline_megadl(client, query):
    try:
        ...
        if megadl_q.strip() == "":
            aboutinlinemsg = """
            ✪ **[Mega.nz-Bot](https://github.com/ezbot9/MegaBot)**
`A Simple ` [Open Source](https://github.com/ezbot9/MegaBot)` Telegram Bot to Do `[More](https://github.com/ezbot9/MegaBot#features)` with Mega.nz Cloud Storage.`
                
**Developed with ❤️ by [Itz-fork](https://github.com/ezbot9)**
"""
            helpinlinemsg = """
